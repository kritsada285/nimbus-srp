 ...
 * 
 * <p>If you don't want to employ the default {@link SRP6Routines#computeU
 * routine} for computing 'H(A | B)' message you can use this interface to
 * define your own. Remember to make sure that exactly the same routine is used
 * by both client and server session, else authentication will fail.
 * 
 * @author Simon Massey
 */
